...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>{{ 'Quickpresse' }} | Admin Login</title>
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="{{ route('admin.login') }}">
                <img src="{{ asset('/') }}sitesetting_images/mid/{{ 'the logo image here' }}" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        @yield('content')
        <div class="copyright"> {{ date('Y')}} © {{ 'Quickpresse' }}. Admin Panel. </div>
        <!--[if lt IE 9]>
